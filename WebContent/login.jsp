...
">
	<div align="center" class="div">
		...
		<table>
			...
			<tr><td><input type="submit" value="登录" style="width:200px;height:25px;"></td></tr>
			<tr><td><button type="button" style="width:200px;height:25px;" onclick="window.location.href='register.jsp'">注册</button></td></tr>
